<div class="form-group" xmlns:wire="http://www.w3.org/1999/xhtml">
    <label class="col-form-label w-100">@lang('tadcms::app.categories')
    ...
    <div class="add-new-form">
        ...
        <button type="button" class="btn btn-primary" wire:click="add"><i class="fa fa-plus-circle"></i> @lang('tadcms::app.add')</button>
    </div>
    @endif
</div>